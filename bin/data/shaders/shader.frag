...
uniform float posDia;
uniform float timeDia;
uniform float timeAdd;
uniform float entireDia;
...
void main(){
    ...
    vec2 shift;
    shift.x = cnoise( vec3( pos*posDia, time * timeDia + timeAdd))*entireDia;
    shift.y = cnoise( vec3( pos*posDia, time *timeDia + timeAdd))*entireDia;
    pos += shift;
